...
|  --- | --- | --- | --- |
| `facade` | [`MediaItem[]`](/doc/models/media-item.md) | Required | Facade photography of a Cookies store. |
| `inside` | [`MediaItem[]`](/doc/models/media-item.md) | Required | Inside photography of a Cookies store. |
| `masthead` | [`MediaItem[]`](/doc/models/media-item.md) | Required | Masthead (featured) photography for a Cookies store. |
